...
3- Operational Expenses
   ...
   * Also necessary
   * Like Groceries, Lights, Water

4- Recreational Fixed Expenses
   * Consistant expenses that occur monthly
   * Hobby subscriptions
   * Streaming expenses
   * Any other fun Expenses
...
6- Investments
   ...
   * Consitant and impulse stuff

7- Goals
   * Something youre saving up towards
   * House, car, etc
